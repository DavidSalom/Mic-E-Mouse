...
class Config:
    def __init__(self, args):
        ...
        parser.add_argument('--VCTK_root_path', type=str, default="/media/data/VCTK-Corpus", help='Path to the VCTK dataset parent folder, which should contain wav48 and txt folders.')
        parser.add_argument('--save_path', type=str, default="./workspace", help='Path to save the models to.')
        parser.add_argument('--load_path', type=str, default=None, help='Path to load the models from.')
